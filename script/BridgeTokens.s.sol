...
contract BridgeTokens is Script {
    ...
    function run(address receiverAddress, uint64 destinationChainSelector, address tokenToSendAddress, address routerAddress, uint256 amountToSend, address linkTokenAddress) public {
